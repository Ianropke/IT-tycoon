...
class MainScene extends Phaser.Scene {
  ...
  create(){
    ...
    // Player near left panel
    this.player=this.physics.add.sprite(200,450,'player_dummy');
    this.player.setCollideWorldBounds(true);

    // We'll place location sprites to the right area (x>400,y>100)
    ...
    this.cyberSecZone=this.physics.add.staticSprite(1050,400,'cybersecurity_dummy');

    // backlog near left side
